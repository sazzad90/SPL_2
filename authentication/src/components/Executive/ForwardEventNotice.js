    ...
    Axios.post('http://localhost:5050/forwardEventNotice', {})
      .then((response) => {
        if (response) {
          ...
          setTitle(' Event Notice: '+eventName+'  '  +formattedDate);
          setBody(
    ...
    <div>
                ...
                <div class = "col-lg-4 d-flex justify-content-center">  </div>
                 <div className='alert alert-success d-flex justify-content-center col-lg-4 mt-4'  role="alert" alignment="center">
                     Event notice is forwarded successfully to Head of PEC
                    </div>
...
export default ForwardEventNotice;
