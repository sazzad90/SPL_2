...
//   const handleForwardNotification = (event) => {
...
//       // Emit the admin notification to the server
...
//         <div class =  "d-flex">
//         <Button variant="primary" onClick={handleForwardNotification} type="submit">Forward notification</Button>
//         </div>
...
//                      Team list notice is forwarded successfully to Head of PEC
//                     </div>
//                     <div class = "col-lg-4">  </div>
//                     </div>
//                 }
